...
Требуется провести детальное сравнение реализованной верстки (http://front-end.fmake.ru/wowwelcome2016) с предоставленным дизайн-макетом (https://www.figma.com/file/DMFp2YmvWcyOq5AC6uM2ZH/WowWelcome).
